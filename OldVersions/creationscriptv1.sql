...
CREATE TABLE IF NOT EXISTS `AMSTestData`.`Test Equipment` (
  `testerID` INT NOT NULL COMMENT 'This is the Unique Identifier for the test tablet. This may be used for multiple tests of different meters',
...
CREATE TABLE IF NOT EXISTS `AMSTestData`.`Test` (
  `testID` INT NOT NULL COMMENT 'This is the Unique Identifier for the Test. This is a Unique value',
...
CREATE TABLE IF NOT EXISTS `AMSTestData`.`Network` (
  `networkID` INT NOT NULL COMMENT 'This is the Unique Identifier for the network. This is split out from the rest as there may be multiple tests for the same network',
...
CREATE TABLE IF NOT EXISTS `AMSTestData`.`Antenna` (
  `antennaID` INT NOT NULL COMMENT 'This is the Unique Identifier for the antenna type. This is used to reduce redundancy',
...
CREATE TABLE IF NOT EXISTS `AMSTestData`.`Signal Type` (
  `signalID` INT NOT NULL COMMENT 'This is the Unique Identifier for the signal. This is used to reduce redundancy.',
...
CREATE TABLE IF NOT EXISTS `AMSTestData`.`Results` (
  `resultID` INT NOT NULL COMMENT 'This is the Unique Identifier for the Test Result.',
...
CREATE TABLE IF NOT EXISTS `AMSTestData`.`Signal Results` (
  `signalResultsID` INT NOT NULL COMMENT 'This is the Unique Identifier for the signalResult.',
  ...
  `signalStrength` DECIMAL(15,12) NULL COMMENT 'Decimal value outlining how strong the connection was to the specific network type',
